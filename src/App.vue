<template>
  <div id="app">
    <header class="header">
      <section class="header_black">
        <div class="container-fluid header__line">
          ...
          <div class="header__right">
            <button class="header-region__button" id="region-search-opener">
              <span class="header-region-button__icon icon-location"></span
              >Москва и область
            </button>
            <button
            ...
            >
              <span
                class="header-notifications-button__icon icon-notifications"
              ></span>
            </button>
          </div>
        </div>
